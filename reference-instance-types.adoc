...
[role="lead"]
NetApp Data Classificationソフトウェアは、特定のオペレーティングシステム要件、RAM要件、およびソフトウェア要件を満たすホスト上で動作する必要があります。クラウド上でData Classificationを導入する場合は、フル機能を利用するために「大規模」な特性を持つシステムを使用してください。
