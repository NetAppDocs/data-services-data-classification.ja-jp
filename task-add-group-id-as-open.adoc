...
summary: NFSファイル共有内のファイルやフォルダにグループIDが関連付けられると、そのファイルやフォルダのアクセス許可が定義されます。グループIDのアクセス許可レベルが「組織に公開」に設定されていない場合は、そのアクセス許可をGIDに追加することで、そのGIDが関連付けられているファイルやフォルダが「組織に公開」されているとみなされるようになります。 
---
