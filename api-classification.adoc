...
summary: Web UI を通じて利用できるNetAppデータ分類機能は、API を通じても利用できます。 
---
= NetAppデータ分類 API
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Web UI を通じて利用できるNetAppデータ分類機能は、REST API を通じても利用できます。
...
Swagger ドキュメントの API を使用すると、検索、データの集約、スキャンの追跡、コピー、移動などのアクションの実行が可能です。
